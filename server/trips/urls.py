...
from .views import set_destination_category, set_accommodation_category, get_accommodations, get_destinations, get_transportations, get_hospitals, get_police_stations
